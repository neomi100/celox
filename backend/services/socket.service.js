...
const yachtService = require('../api/yacht/yacht.service')
...
function connectSockets(http, session) {
    ...
    gIo.on('connection', socket => {
        ...
        socket.on('renderOrders',(owner)=>{
            gIo.emit ('loadOrders' ,owner ) // should be - gIo.to(ownerId).emit('loadOrders', owner)// for reloading only for relevant user
        })
